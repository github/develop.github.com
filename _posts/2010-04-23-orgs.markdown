...
### Fetching and Updating Team Information
    ...
    /organizations/:org/teams/:team_id [GET]

    $ curl https://github.com/api/v2/json/organizations/github/teams/10 [GET]
    {
      "team": {
        "name": "Open Source",
        "id": 10,
...
Content-Type):
    ...
    /organizations/:org/teams/:team_id [PUT]

    $ curl -X PUT -d '{"team": {"name": "OSS"}}' \
      -H "Content-Type: application/json"        \
      https://github.com/api/v2/json/organizations/github/teams/10
    {
      "team": {
        "name": "OSS",
        "id": 10,
...
You can also DELETE a Team:
    ...
    /organizations/:org/teams/:team_id [DELETE]
...
To list users:
    ...
    /organizations/:org/teams/:team_id/members [GET]

    $ curl https://github.com/api/v2/json/organizations/github/teams/10/members
...
To add a user to the team:
    ...
    /organizations/:org/teams/:team_id/members?name=:user [POST]

    $ curl -d "name=technoweenie" https://github.com/api/v2/json/organizations/github/teams/10/members

To remove a user from the team:

    /organizations/:org/teams/:team_id/members?name=:user [DELETE]

### Team Repositories

To list repositories:

    /organizations/:org/teams/:team_id/repositories [GET]

    $ curl https://github.com/api/v2/json/organizations/github/teams/10/repositories
...
To add a repo to the team:
    ...
    /organizations/:org/teams/:team_id/repositories?name=:user/:repo [POST]

    $ curl -d "name=github/gollum" https://github.com/api/v2/json/organizations/github/teams/10/repositories

To remove a repo from the team:

    /organizations/:org/teams/:team_id/repositories?name=:user/:repo [DELETE]
